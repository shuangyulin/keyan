		...
		<div class="col-md-12 wow fadeInUp" data-wow-duration="0.5s">
			<div>
				...
				<ul class="nav nav-tabs" role="tablist">
			    	<li role="presentation" ><a href="<%=basePath %>Manager/frontlist">项目管理员列表</a></li>
			    	<li role="presentation" class="active"><a href="#managerAdd" aria-controls="managerAdd" role="tab" data-toggle="tab">添加项目管理员</a></li>
				</ul>
				<!-- Tab panes -->
